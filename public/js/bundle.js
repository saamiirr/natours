...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibW9zYW1pciIsImEiOiJjbHY5MjZkM2IwcWN3MnJtenU5bTh1YWZ6In0.1uyLvmlolcVORVfziVHSYA';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/mosamir/clv92j7us00o301qz35jjeglv',
    // style URL
    scrollZoom: false
...
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51PAluHRwdfFFcpzMpImXoqUYxeKr2vQg4sHcRReAnDZXrBB8eLYyomEaHbdOjn4FlSeds0vgY0EQ4NLp5H0CXV3p00vM4XScdq');
          _context.prev = 1;
          _context.next = 4;
    ...
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            document.querySelector('.btn--save-password').textContent = 'Updaing...';
